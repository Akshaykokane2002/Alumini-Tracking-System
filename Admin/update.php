...
if (isset($_POST['update']) && isset($_POST['id'])) {
    ...
    $sql = "UPDATE data SET name='$name', batch='$batch',contact='$contact', email='$email', pic='$pic' WHERE id='$id'";

    if ($conn->query($sql) === TRUE) {
        echo '<script>alert("Update successful"); window.location.href = "display.php";</script>';
    } else {
